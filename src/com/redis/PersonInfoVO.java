...
public class PersonInfoVO {
	...
	public String toString() {
		return "PersonInfoVO [Name=" + Name + ", CardNo=" + CardNo + ", Descriot=" + Descriot + ", CtfTp=" + CtfTp
				+ ", CtfId=" + CtfId + ", Gender=" + Gender + ", Birthday=" + Birthday + ", Address=" + Address
				+ ", Zip=" + Zip + ", Dirty=" + Dirty + ", District1=" + District1 + ", District2=" + District2
				+ ", District3=" + District3 + ", District4=" + District4 + ", District5=" + District5 + ", District6="
				+ District6 + ", FirstNm=" + FirstNm + ", LastNm=" + LastNm + ", Duty=" + Duty + ", Mobile=" + Mobile
				+ ", Tel=" + Tel + ", Fax=" + Fax + ", EMail=" + EMail + ", Nation=" + Nation + ", Taste=" + Taste
				+ ", Education=" + Education + ", Company=" + Company + ", CTel=" + CTel + ", CAddress=" + CAddress
				+ ", CZip=" + CZip + ", Family=" + Family + ", Version=" + Version + ", id=" + id + "]";
	}
